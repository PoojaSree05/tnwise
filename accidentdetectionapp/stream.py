...
class streaming(object):
    def __init__(self):
        ...
        self.model1 = torch.hub.load('ultralytics/yolov5', 'custom', path='C:\\Users\\user\\Downloads\\OSDHack-22_AccidentDetectionAI-main\\OSDHack-22_AccidentDetectionAI-main\\best (2).pt', device='cpu')
        self.model = torch.hub.load('ultralytics/yolov5', 'custom', path='C:\\Users\\user\\Downloads\\OSDHack-22_AccidentDetectionAI-main\\OSDHack-22_AccidentDetectionAI-main\\accident2.pt', device='cpu')
